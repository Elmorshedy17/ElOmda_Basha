...
class ResendOrderDetailsBloc {

  final BehaviorSubject counteryTitle = BehaviorSubject();
  final BehaviorSubject counteryId = BehaviorSubject();
  final BehaviorSubject cityTitle = BehaviorSubject();
  final BehaviorSubject cityId = BehaviorSubject();
