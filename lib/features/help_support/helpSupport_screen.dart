                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: StreamBuilder(
                                      ...
                                      builder: (context, typeComplainSnapshot) {
                                        return ExpansionTile(
                                          title: Column(
                                            ...
                                            children: <Widget>[
                                              ...
                                              typeComplainSnapshot.hasData?Text(
                                                typeComplainSnapshot.data,
                                                style: TextStyle(
...
//                                      subtitle: ,
                                          ...
                                          children: <Widget>[
                                            ...
                                            ListView.builder(
                                              ...
                                              itemCount: model.data.complaintTypes.length,
                                              itemBuilder: (context, index) {
                                                return   InkWell(
                                                  onTap: () {
                                                    typeComplain.add( model.data.complaintTypes[index].name);
//                                                    complainId.add( model.data.complaintTypes[index].id);
                                                    complainId = model.data.complaintTypes[index].id;
...
//                              padding: const EdgeInsets.all(8.0),
                                                    child: Center(
                                                      child: Text(
                                                        model.data.complaintTypes[index].name,
                                                        style: TextStyle(
                                    ...
                                    child: ButtonTheme(
                                      ...
                                      child: RaisedButton(
                                        ...
                                        onPressed: () {
                                          ...
                                          ContactUsPostRepo.postContactUsData(nameController.text,emailController.text,phoneController.text,complainId,messageController.text).then((onValue){
                                            isLoading.add(false);
                                            showDialog(
                                              context: context,
