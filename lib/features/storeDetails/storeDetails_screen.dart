      ...
      child: MainBackground(
        ...
        child: Scaffold(
          ...
          body: CustomObserver(
            ...
            onSuccess: (_, StoreDetailsModel model) {
              print(model.data.seller.id);
              return Column(
                        ...
                        children: <Widget>[
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: IconButton(
                                    ...
                                    onPressed: () {
                                      _launchMapsUrl(
                                          double.parse(model.data.seller.lat),
                                          double.parse(model.data.seller.lng));
                                    },
                                  ),
                                ),
                                Container(
                                        ...
                                        model.data.seller.favourite == 'yes'
                                            ...
                                            : locator<FavoritesActionsManager>()
                                                .addOrRemoveFavorite(
                                                    ...
                                                    model.data.seller.id
                                                        .toString());
                                        locator<StoreDetailsManager>()
                                            .getData(args.sellerId);
                                      }
                                    },
                                  ),
                                ),
                          ...
                          Container(
                            ...
                            child: ListView.builder(
                              ...
                              scrollDirection: Axis.horizontal,
                              itemCount:
                                  model.data.seller.productsFeatured?.length ??
                                      0,
                          ...
                          model.data.seller.menu?.length == 0
                              ? Container()
                              : Padding(
