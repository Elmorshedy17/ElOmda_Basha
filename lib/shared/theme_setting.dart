...
const mainColor = const Color(0xFF143567);
const secondColor = const Color(0xFF1C4077);
const orangeColor = const Color(0xFFFF8C01);
...
/// new coubonate
const SoRed = const Color(0xFFF34858); // grey blue
...
class MySeparatorCard extends StatelessWidget {
  final double height;
  final Color color;

  const MySeparatorCard({this.height = 1, this.color = Colors.black});
