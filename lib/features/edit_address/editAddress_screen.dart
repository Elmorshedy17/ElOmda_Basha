...
class _EditAddressScreenState extends State<EditAddressScreen> {
  ...
  void initState() {
    super.initState();
    blockController = new TextEditingController(text: widget.modelData.data.address.block);
    streetController = new TextEditingController(text: widget.modelData.data.address.street);
    streetTwoController = new TextEditingController(text: widget.modelData.data.address.street2);
    houseController = new TextEditingController(text: widget.modelData.data.address.building);
    floorController = new TextEditingController(text: widget.modelData.data.address.floor);
    jaddaController = new TextEditingController(text: widget.modelData.data.address.jadda);
    appartmentController = new TextEditingController(text: widget.modelData.data.address.flat);
    deliveryController = new TextEditingController(text: widget.modelData.data.address.notes);
  }
...
//                          });
                        ...
                        print("locator<DrobDownBloc>().currentDrobDownvalue ${locator<EditDrobDownBloc>().currentDrobDownvalue}");

                        if(locator<EditDrobDownBloc>().currentDrobDownvalue == null || blockController.text.length == 0 || streetController.text.length == 0 ||streetTwoController.text.length == 0 ||houseController.text.length == 0 ||floorController.text.length == 0||jaddaController.text.length == 0 ){
                          showDialog(
                            context: context,
                            builder: (BuildContext context) {
                              return AlertDialog(
                          ...
                          isLoading.add(true);
                          EditAddressRepo.postEditAddressData(locator<EditDrobDownBloc>().currentDrobDownvalue ==  null ? "" : locator<EditDrobDownBloc>().currentDrobDownvalue ,blockController.text,streetController.text,streetTwoController.text,houseController.text,floorController.text,jaddaController.text,appartmentController.text,deliveryController.text, widget.modelData.data.address.id).then((onValue){
                            isLoading.add(false);
                            showDialog(
                              context: context,
                              builder: (BuildContext context) {
