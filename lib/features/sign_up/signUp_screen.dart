...
//                                      await DataConnectionChecker().hasConnection;
                                      ...
                                      RegisterRepo.postRegisterData(emailController.text,phoneController.text,passwordController.text,confirmController.text,firstNameController.text,middleNameController.text,lastNameController,addressController.text ).then((onValue){
                                        isLoading.add(false);
                                        if(onValue.status == 1){
