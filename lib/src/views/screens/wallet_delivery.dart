...
class WalletDelivery extends StatefulWidget {
  var data;
  WalletDelivery(this.data);
  @override
  _WalletDeliveryState createState() => _WalletDeliveryState();
}

class _WalletDeliveryState extends State<WalletDelivery> {
  final GlobalUserType = locator<PrefsService>().userType == null ? locator<UserTypeBloc>().currentUserType:locator<PrefsService>().userType;
  @override
  Widget build(BuildContext context) {
    print("locator<UserTypeBloc>().currentUserType${locator<UserTypeBloc>().currentUserType}");
              ...
              child: SingleChildScrollView(
                child: Wrap(
                  children: <Widget>[
                    ...
                    GlobalUserType !="delegate"?  _thidStatistics():Container(),
                    Container(
                      height: 15.0,
                    ),
                    _transfrerOrder(),
                    ...
                    Center(
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
//                          "1000",
                              GlobalUserType !="delegate"?  widget.data.totalCommission.toString() : widget.data.total.toString(),
                              style: TextStyle(
                                  fontWeight: semiFont,
              ...
              GlobalUserType !="delegate"?    Container(
                height: 45.0,
                child: VerticalDivider(
                  color: Colors.blue,
                ),
              ):Container(),
              GlobalUserType !="delegate"?   Expanded(
                child: Wrap(
                  children: <Widget>[
                    Center(
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Row(
                        ...
                        children: <Widget>[
                          Text(
                            GlobalUserType !="delegate"?  widget.data.needCommission.toString() : widget.data.debt.toString(),
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Row(
                        ...
                        children: <Widget>[
                          Text(
                            GlobalUserType !="delegate"? (widget.data.totalCommission - widget.data.needCommission).toString() : (widget.data.total - widget.data.debt).toString(),
                            style: TextStyle(
                                fontWeight: semiFont,
                                fontSize: PrimaryFont,
                                color: Colors.redAccent),
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: ListTile(
          ...
          onTap: (){
            ...
            Navigator.push(
                ...
                new MaterialPageRoute(
                    builder: (BuildContext context) => GlobalUserType !="delegate"? MoneyTransform():DeliveryMoneyTransfere()));
          },
          leading:  Image.asset(
          ...
          title: Align(
            child: Text(
              GlobalUserType !="delegate"?  AppLocalizations.of(context).translate("Amount_Transfere_Orders_str") : AppLocalizations.of(context).translate("Amount_Transfere_str") ,
              style:
              TextStyle(fontWeight: bolFont, fontSize: MediumFont),
            ),
