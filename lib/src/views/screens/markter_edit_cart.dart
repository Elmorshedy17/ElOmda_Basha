...
class MarketerEditCart extends StatelessWidget {
  final varuableDiscountRate;
  final orderID;
  MarketerEditCart(this.varuableDiscountRate,this.orderID);
                    ...
                    child: InkWell(
                      onTap: (){
                                      ...
                                      children: [
                                        InkWell(
                                          onTap: (){
                                            ...
                                            ApiService.UpdateMarkterOrder(orderID,"").then((onValue){
                        ...
                        child: Container(
                          ...
                          locator<IsLoadingManager>().isLoading.add(true);
                          ApiService.UpdateMarkterOrder(orderID,how).then((onValue){
                            locator<IsLoadingManager>().isLoading.add(false);
