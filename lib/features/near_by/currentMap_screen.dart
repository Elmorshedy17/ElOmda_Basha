...
class CurrentMapScreenArguments {
  final double lat;
  final double lng;

  CurrentMapScreenArguments({@required this.lat, @required this.lng});
}

class CurrentMapScreen extends StatefulWidget {
  @override
  _CurrentMapScreenState createState() => _CurrentMapScreenState();
}

class _CurrentMapScreenState extends State<CurrentMapScreen> {
  Completer<GoogleMapController> _controller = Completer();
  CurrentMapScreenArguments args;
